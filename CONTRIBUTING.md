...
3. Work that will ship is mirrored **manually** into the private monorepo as PRODUCT / `specs/…` — public Issues are **not** executable specs.
...
This repository has **no application source**. Product code lives in the private NT² monorepo and is not contributed here.
